    ...
    public class StudyResultController : Controller
    {
        ...
        public ActionResult Import(HttpPostedFileBase postedFile)
        {
            ...
            if (postedFile != null)
            {
                ...
                var query_studentcourse_studyresult = db.study_results.FirstOrDefault(s => s.student_course_id == studentCourseId);
                ...
                try
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        var query_classstudent = db.class_student.FirstOrDefault(c => c.id == classStudentId);
